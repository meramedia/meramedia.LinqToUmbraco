...
namespace meramedia.Linq.Core.Dashboard
{
    public partial class ExportCode : UserControl
    {
        //public ExportCode()
        //{
        //    CurrentApp = umbraco.BusinessLogic.DefaultApps.developer.ToString();
        //}
...
namespace {0} {{
	...
	public partial interface I{0} : I{3} {{
        ...
        protected void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            EnsureExportFolder();
            string pocoFile = Path.Combine(SystemDirectories.Media + EXPORT_FOLDER, this.txtDataContextName.Text + ".txt");
            ...
            if (includeInterfaces)
            {
                ...
                string abstractionFile = Path.Combine(SystemDirectories.Media + EXPORT_FOLDER, "I" + this.txtDataContextName.Text + ".txt");

                using (var writer = new StreamWriter(IOHelper.MapPath(abstractionFile)))
                {
        ...
        {
            string packagesDirectory = SystemDirectories.Media + EXPORT_FOLDER;
